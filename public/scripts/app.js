...
const REPO_THEMES = {
    core: {
        ...
        items: [
            ...
            { id: "fastapi/fastapi", why: { it: "Lo standard moderno per creare API veloci con Python: ideale per esporre i tuoi modelli AI in produzione.", en: "The modern standard for building fast APIs in Python: ideal to expose your AI models in production." } },
    ...
    genai: {
        ...
        items: [
            ...
            { id: "Comfy-Org/ComfyUI", why: { it: "Interfaccia a nodi per Stable Diffusion: massima flessibilità per workflow complessi di generazione e post-processing.", en: "Node-based UI for Stable Diffusion: maximum flexibility for complex generation and post-processing workflows." } },
            ...
            { id: "sgl-project/sglang", why: { it: "Motore di serving pensato per prompt condivisi e generazione strutturata: con RadixAttention riusa i prefissi comuni, quindi vince dove vLLM pareggia (agenti, few-shot, RAG).", en: "Serving engine built for shared prompts and structured generation: RadixAttention reuses common prefixes, so it wins where vLLM ties (agents, few-shot, RAG)." } },
            ...
            { id: "ggml-org/llama.cpp", why: { it: "Il 'miracolo' che porta gli LLM su CPU e Apple Silicon: ideale per chi vuole modelli grandi su hardware non enterprise.", en: "The 'miracle' bringing LLMs to CPU and Apple Silicon: ideal if you want big models on non-enterprise hardware." } },
    ...
    agentic: {
        ...
        items: [
            ...
            { id: "openinterpreter/openinterpreter", why: { it: "Permette a un LLM di eseguire vero codice sul tuo computer (shell, Python, ecc.): ponte diretto tra modello e ambiente locale.", en: "Lets an LLM execute real code on your machine (shell, Python, etc.): a direct bridge between model and local environment." } },
    ...
    ml: {
        ...
        items: [
            ...
            { id: "lightgbm-org/LightGBM", why: { it: "Gradient boosting veloce ed efficiente con ottima gestione di grandi dataset: alternativa spesso più leggera rispetto ad altri.", en: "Fast, efficient gradient boosting with great handling of large datasets: often a lighter alternative to others." } },
            ...
            { id: "jax-ml/jax", why: { it: "Autograd e XLA per calcolo ad alte prestazioni: ponte naturale tra numerica classica e sperimentazione deep moderna.", en: "Autograd and XLA for high-performance computation: a natural bridge between classic numerics and modern deep experiments." } }
        ]
    },
    opensource: {
        ...
        briefing: {
            it: "Piattaforme, modelli open-weight e progetti comunitari: qui si muove l’AI aperta, dove puoi ispezionare, forchettare e costruire sopra. Il baricentro si è spostato: oggi i pesi che contano arrivano tanto da Meta e OpenAI quanto da DeepSeek, Alibaba e Moonshot.",
            en: "Platforms, open-weight models and community projects: this is where open AI lives, where you can inspect, fork and build on top. The centre of gravity has shifted: the weights that matter now come as much from DeepSeek, Alibaba and Moonshot as from Meta and OpenAI."
        },
        items: [
            ...
            { id: "deepseek-ai/DeepSeek-R1", why: { it: "Il modello di reasoning che ha riscritto il rapporto costo/qualità: licenza MIT, catena di pensiero esposta, prestazioni da frontiera senza costi da frontiera.", en: "The reasoning model that rewrote the cost/quality ratio: MIT licensed, exposed chain of thought, frontier performance without frontier cost." } },
            { id: "QwenLM/Qwen3.8", why: { it: "La famiglia Qwen di Alibaba, oggi alla 3.8: taglie da edge a frontiera e ottima resa multilingua, con la variante 27B sotto Apache 2.0. È la base open-weight più scaricata su Hugging Face.", en: "Alibaba's Qwen family, now at 3.8: sizes from edge to frontier with strong multilingual quality, and the 27B variant under Apache 2.0. The most downloaded open-weight base on Hugging Face." } },
            { id: "meta-llama/llama-models", why: { it: "Il repo ufficiale dei pesi Llama, oggi alla generazione 4 (Scout e Maverick): la famiglia open-weight che ha aperto la strada a tutte le altre.", en: "The official Llama weights repo, now on generation 4 (Scout and Maverick): the open-weight family that paved the way for all the others." } },
            { id: "openai/gpt-oss", why: { it: "Il ritorno di OpenAI ai pesi aperti: modelli scaricabili ed eseguibili in locale, utili per confrontare la scuola americana con quella cinese.", en: "OpenAI's return to open weights: downloadable models you can run locally, useful to compare the American and Chinese schools head to head." } },
...
const TITAN_THEMES = {
    meta: {
        ...
        items: [
            { id: "meta-llama/llama-models", why: { it: "La famiglia di modelli open più influente degli ultimi anni, oggi alla generazione 4: ha sbloccato ecosistemi interi (fine-tuning, inference, strumenti, UI) su hardware accessibile.", en: "The most influential open model family in recent years, now on generation 4: it unlocked entire ecosystems (fine-tuning, inference, tools, UIs) on accessible hardware." } },
            ...
            { id: "facebookresearch/xformers", why: { it: "Blocchi Transformer ottimizzati per memoria e velocità (attention efficiente, kernel custom): usato sotto il cofano da molti stack di training e inferenza.", en: "Memory- and speed-optimized Transformer building blocks (efficient attention, custom kernels): used under the hood by many training and inference stacks." } }
        ]
    },
    microsoft: {
        label: "MICROSOFT",
        ...
        items: [
            ...
            { id: "deepspeedai/DeepSpeed", why: { it: "Stack di ottimizzazione per addestrare modelli di grandi dimensioni in modo efficiente (parallelismo, memory saving, throughput elevato).", en: "Optimization stack for training large models efficiently (parallelism, memory savings, high throughput)." } },
            ...
            { id: "guidance-ai/guidance", why: { it: "Linguaggio dichiarativo per controllare il comportamento degli LLM (template, vincoli, strutture). Utile quando serve output molto deterministico.", en: "Declarative language to control LLM behavior (templates, constraints, structures). Useful when you need highly deterministic outputs." } },
    ...
    google: {
        ...
        items: [
            ...
            { id: "jax-ml/jax", why: { it: "Il laboratorio numerico di Google: autograd + XLA per calcolo ad alte prestazioni: ponte naturale tra numerica classica e sperimentazione deep moderna.", en: "Google’s numerical lab: autograd + XLA for high-performance research and training on TPUs and GPUs." } },
            { id: "google-ai-edge/LiteRT", why: { it: "Runtime on-device di Google (erede di TensorFlow Lite) per eseguire modelli GenAI e ML dentro app mobile e web: perfetto per esperienze low-latency e offline.", en: "Google's on-device runtime (successor to TensorFlow Lite) for running GenAI and ML models inside mobile and web apps: ideal for low-latency, offline experiences." } }
        ]
    },
    openai: {
        label: "OPENAI",
    ...
    huggingface: {
        ...
        items: [
            ...
            { id: "huggingface/trl", why: { it: "Libreria per il post-training degli LLM (SFT, DPO, GRPO e RLHF): il passo che trasforma un modello base in un assistente allineato.", en: "Library for LLM post-training (SFT, DPO, GRPO and RLHF): the step that turns a base model into an aligned assistant." } }
        ]
    },
    nvidia: {
        label: "NVIDIA",
        ...
        items: [
            { id: "NVIDIA-NeMo/Speech", why: { it: "Il ramo speech di NeMo (ASR, TTS, speaker): modelli e pipeline pronte per costruire sistemi vocali di produzione su GPU NVIDIA.", en: "The speech branch of NeMo (ASR, TTS, speaker): ready-made models and pipelines to build production voice systems on NVIDIA GPUs." } },
    ...
    mistral: {
        ...
        briefing: {
            it: "Chi insegue la frontiera e spesso la raggiunge: DeepSeek, Moonshot, Z.ai, Mistral, Cohere. Questi laboratori rilasciano pesi aperti a ritmo serrato e nel 2026 valgono circa un terzo dell’uso open-weight globale.",
            en: "The labs chasing the frontier — and often catching it: DeepSeek, Moonshot, Z.ai, Mistral, Cohere. They ship open weights at a relentless pace and in 2026 account for roughly a third of global open-weight usage."
        },
        items: [
            { id: "deepseek-ai/DeepSeek-V3", why: { it: "L’architettura Mixture-of-Experts che ha reso DeepSeek un caso: attiva una frazione dei parametri totali, qualità da frontiera a costo contenuto. Resta il riferimento tecnico della serie V, arrivata poi a V4 con pesi MIT distribuiti su Hugging Face.", en: "The Mixture-of-Experts architecture that made DeepSeek's name: it activates a fraction of total parameters for frontier quality at contained cost. Still the technical reference for the V series, since continued to V4 with MIT weights distributed on Hugging Face." } },
            { id: "MoonshotAI/Kimi-K3", why: { it: "Il modello di punta di Moonshot AI: 2.8T parametri totali con 104B attivi, contesto da 1M token e visione nativa. Oggi è considerato il migliore fra gli open-weight generalisti.", en: "Moonshot AI's flagship: 2.8T total parameters with 104B active, 1M-token context and native vision. Currently regarded as the best open-weight all-rounder." } },
            { id: "zai-org/GLM-5", why: { it: "La famiglia GLM di Z.ai: ~753B parametri, contesto da 1M token e pesi sotto licenza MIT. È il riferimento fra gli open-weight per coding e agenti a lungo orizzonte.", en: "Z.ai's GLM family: ~753B parameters, 1M-token context and MIT-licensed weights. The open-weight benchmark for coding and long-horizon agents." } },
            { id: "mistralai/mistral-inference", why: { it: "Libreria di inferenza ufficiale per i modelli Mistral: la via più diretta per portare in produzione i loro LLM, forti sul rapporto qualità/risorse.", en: "Official inference library for Mistral models: the most direct way to put their LLMs into production, strong on the quality-to-resources ratio." } },
    ...
    anthropic: {
        ...
        items: [
            ...
            { id: "anthropics/claude-cookbooks", why: { it: "Repository essenziale con esempi avanzati (RAG, citazioni con fonti, Vision, tool use): perfetto come “laboratorio” per progetti seri.", en: "Essential repo with advanced examples (RAG, cited answers, Vision, tool use): perfect as a 'lab' for real projects." } },
...
const DOCS_DATA = [
    ...
    { name: "Anthropic – Claude", link: "https://docs.anthropic.com/", linkText: "docs.anthropic.com", models: "Claude Opus 5, Sonnet 5, Haiku 4.5", hosting: "Console, AWS Bedrock, Azure" },
    ...
    { name: "xAI – Grok", link: "https://docs.x.ai/", linkText: "docs.x.ai", models: "Grok 4.6, reasoning, vision", hosting: "Cloud xAI, Azure" },
    { name: "Meta – Llama API", link: "https://llama.developer.meta.com/docs/overview", linkText: "llama.developer.meta.com", models: "Llama 4 (Scout, Maverick)", hosting: "Managed API, AWS, Azure" },
    ...
    { name: "Google Cloud – Vertex AI", link: "https://docs.cloud.google.com/gemini/docs", linkText: "Google Cloud Docs", models: "Gemini, Gemma, Model Garden", hosting: "Google Cloud managed platform" },
    ...
    { name: "Devin Desktop (ex Windsurf)", link: "https://docs.devin.ai/desktop/getting-started", linkText: "docs.devin.ai/desktop", models: "AI-first IDE, agent workflows", hosting: "Desktop", group: "ide" },
    ...
    { name: "Tabnine", link: "https://docs.tabnine.com/", linkText: "docs.tabnine.com", models: "Autocomplete, chat", hosting: "VS Code, JetBrains, Neovim", group: "ide" },
